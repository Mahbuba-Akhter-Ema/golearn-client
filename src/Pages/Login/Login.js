...
const Login = () => {
    ...
    return (
        <div className="w-full mx-auto max-w-md m-5 p-4 rounded-md shadow sm:p-8 bg-gray-600 text-gray-100">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col w-full max-w-lg p-12 rounded  bg-gray-700  text-gray-100" noValidate="" action="">
                ...
                <button type="submit" className="flex items-center justify-center h-12 px-6 mt-8 text-sm font-semibold rounded hover:bg-red-300 bg-violet-400 text-gray-900">Log In</button>
