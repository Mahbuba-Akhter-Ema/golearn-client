...
const Footer = () => {
    return (
      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid row-gap-10 mb-2 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-500">
              Stay Connected For Latest Updates and Features.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
          <p className="text-sm text-gray-500">
            © Copyright 2022 Mahbuba Akhter. All rights reserved.
          </p>
          <div className="flex mx-28 lg:mx-0 items-center mt-4 space-x-4 sm:mt-0">
            <a
              href="/"
